...
void setup()
{
  pinMode(NP_SEL1, INPUT);
  pinMode(NP_SEL2, INPUT);
  ...
  if (MIDI.read(MIDI_CHANNEL)) {
    ...
    switch (type) {
      ...
      case midi::PitchBend:
        ...
        setVoltage(DAC2, 0, 1, d2 << 4); // DAC2, channel 0, gain = 1X
      ...
      case midi::ControlChange:
        ...
        // and choose gain = 2X
        setVoltage(DAC2, 1, 0, d2 << 5); // DAC2, channel 1, gain = 2X
        break;
      ...
      case midi::AfterTouchChannel:
        ...
        // CC range from 0 to 4095 mV  Left shift d2 by 5 to scale from 0 to 4095,
        // and choose gain = 2X
        setVoltage(DAC1, 1, 0, d1 << 5); // DAC1, channel 1, gain = 2X
        break;
